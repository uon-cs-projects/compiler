...
void error_match(int expected_tok_type, const Token *got, const char *filename, const char *source_code);
void error_predict(int nonterminal_idx, const Token *got, const char *filename, const char *source_code);
